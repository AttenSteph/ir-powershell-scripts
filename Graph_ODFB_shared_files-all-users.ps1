...
$tenantID = "<guid>" #your tenantID as guid
$appID = "<guid>" #the GUID of your app. For best result, use app with Sites.ReadWrite.All scope granted.
$client_secret = "<longstring>" #client secret for the app
